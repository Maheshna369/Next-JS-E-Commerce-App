...
const CategoryProducts = (props) => {
  ...
  return (
    <>
      {loading && (
        <div className="w-screen h-screen flex justify-center items-center backdrop-blur-sm fixed inset-0 z-[1000]">
          <PuffLoader />
        </div>
      )}
      <ToastContainer />
...
export default dynamic(() => Promise.resolve(CategoryProducts), { ssr: false });
